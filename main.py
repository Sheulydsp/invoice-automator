...
from parser import extract_invoice_number, extract_date, extract_due_date, extract_discount, extract_shipping_cost, extract_total_amount
...
def main():
    ...
    for filename in os.listdir(INVOICE_DIR):
        if filename.endswith('.pdf'):
            ...
            discount = extract_discount(raw_text)
            shipping_cost = extract_shipping_cost(raw_text)
